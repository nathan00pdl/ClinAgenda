...
namespace ClinAgenda.Core.Interfaces
{
    ...
    {
        Task<(int total, IEnumerable<AppointmentListDTO> appointment)> GetAllppointmentAync(String? patientName, String? doctorName, int? specialtyId, int itemsPerPage, int page);
