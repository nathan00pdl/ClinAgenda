...
<template>
  <DefaultTemplate>
    <template #title> List of Patients </template>

    <template #action>
      <v-btn color="primary" :prepend-icon="mdiPlusCircle" :to="{ name: 'patient-insert' }"> Add Patient </v-btn>
    </template>
    ...
    <template #default>
      ...
      >
        ...
        <template #[`item.actions`]="{ item }">
          <v-tooltip text="Delete Patient" location="left">
          ...
          <v-tooltip text="Edit Patient" location="left">
            <template #activator="{ props }">
              <v-btn
                v-bind="props"
